#include "shell.h"
/**
 * get_history_file - gets the path of the history file
 ...
 * @info: pointer to the parameter struct
 *
 * Return: the number of history entries on success, or 0 on failure
 */
...
/**
 * renumber_history - renumbers the history linked list after changes made
 *
 * @info: pointer to parameter
 *
 * Return: the number of history entries on success, or 0 on failure
